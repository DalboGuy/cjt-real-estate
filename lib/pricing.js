...
function ownerAdjustedQuote(existing,lodgingSubtotal){
  ...
  return {
    ...
    taxes,total,paymentSchedule:paymentScheduleFor(total,base.checkin),
    ownerAdjusted:true,quoteVersion:'owner-adjusted-v2',quotedAt:new Date().toISOString(),
    legacy:false
  };
}

module.exports={WEEKEND_DAYS,SEASONS,CLEANING_FEE,TAX_RATE,PRICING_THROUGH,MAX_GUESTS,SPLIT_PAYMENT_THRESHOLD_DAYS,ADVANCE_PAYMENT_PCT,eachDate,quoteStay,ownerAdjustedQuote,paymentScheduleFor,normalizeOwnerQuote};
