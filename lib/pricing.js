...
function quoteStayWithCatalog(catalog,checkin,checkout,guests=1){
  ...
  // Guest quotes accept 1-night stays. Season minNights stays owner-editable metadata only.
  const minimumStay=1;
  if(nights.length<minimumStay)throw pricingError('minimum_stay','Choose at least one night.');
