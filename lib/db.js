...
async function ensureSchema() {
  ...
  schemaReady = (async () => {
    ...
    `;
    await sql`ALTER TABLE reservations DROP CONSTRAINT IF EXISTS reservation_guest_count_valid`;
    await sql`ALTER TABLE reservations ADD CONSTRAINT reservation_guest_count_valid CHECK (guests BETWEEN 1 AND 14)`;
