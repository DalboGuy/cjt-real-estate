...
async function ensureSchema() {
  ...
  schemaReady = (async () => {
    ...
    `;
    await sql`CREATE INDEX IF NOT EXISTS booking_completion_tokens_reservation_idx ON booking_completion_tokens(reservation_id, created_at DESC)`;
    await sql`
    ...
    `;
    await sql`CREATE INDEX IF NOT EXISTS owner_notifications_unread_idx ON owner_notifications(created_at DESC) WHERE read_at IS NULL`;
