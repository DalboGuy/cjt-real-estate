...
const FOOTER_LINKS = Object.freeze([
  ...
  { id: 'guest-site', label: 'Guest site', href: '/', target: '_blank' }
]);
...
const KPI_DESTINATIONS = Object.freeze({
  ...
  financialsPeriod: (period = 'month') => withQuery('/owner-v1/financials', { period, section: 'overview' }),
  financialsChannel: (channel) => withQuery('/owner-v1/financials', { channel, section: 'channels' }),
  financialsStays: (period = 'month') => withQuery('/owner-v1/financials', { period, section: 'stays' }),
  financialsUpcoming: () => withQuery('/owner-v1/financials', { section: 'upcoming', period: 'all' }),
