...
const {safeEqual,setSessionCookie,clearSessionCookie}=require('../lib/auth');
...
module.exports=async function(req,res){
  try{
    ...
    if(req.method==='GET'){
      ...
      return res.status(200).json({reservations:reservationsWithPayments,ownerAuthOpen:ownerAuthOpen()});
    }
