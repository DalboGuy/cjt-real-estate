...
module.exports=async function(req,res){
  ...
  try{
    ...
    if(!validDate(checkin)||!validDate(checkout)||checkout<=checkin||!Number.isInteger(guests)||guests<1||guests>12){
      return res.status(400).json({error:'invalid_request',message:'Select valid dates and a guest count of 1–12.'});
    }
