(function(){
  ...
  if(location.pathname.replace(/\/$/,'')==='/admin-v1/maps'){
    ...
    if(version)version.textContent='Version 1.2';
    ...
    if(roadmap&&!document.getElementById('guest-listing-experience')){
      ...
      section.innerHTML='<div class="card-head"><div><h3>Guest Listing Experience</h3><p>Listing-first booking UI modeled on familiar vacation-rental interaction patterns while keeping CJT branding.</p></div><span class="badge good">v1.2</span></div><div class="map-board"><div class="map-root"><div class="map-row"><div class="map-node public built"><strong>Photo Mosaic</strong><span>full categorized gallery</span></div><div class="map-arrow">→</div><div class="map-node public built"><strong>Property Story</strong><span>5 bedrooms · 3 baths · 14 guests</span></div><div class="map-arrow">→</div><div class="map-node public built"><strong>Amenities + Sleeping</strong></div><div class="map-arrow">→</div><div class="map-node external built"><strong>Guest Reviews + Map</strong></div><div class="map-arrow">→</div><div class="map-node public built"><strong>Hosted by CJT Realty</strong><span>rules · pets/events · cancellation</span></div><div class="map-arrow">→</div><div class="map-node public built"><strong>Sticky Book Now</strong></div></div><div class="flow-note">Desktop keeps the booking card beside the listing. Mobile uses a one-column listing with a persistent Book Now bar. Pets and events are case-by-case and prompt the guest to ask CJT before approval.</div></div></div>';
      roadmap.parentNode.insertBefore(section,roadmap);
      const toolbar=document.querySelector('.map-toolbar');
