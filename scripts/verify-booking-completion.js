...
assert.match(listingSrc, /CTA_RESERVE='Reserve'/);
assert.match(listingSrc, /showRequestStep/);
assert.match(listingSrc, /paintReview/);
assert.match(listingSrc, /paintPriceStep/);
assert.match(listingSrc, /reviewStayTitle|reviewDates/);
assert.match(listingSrc, /request-review-open/);
assert.match(listingSrc, /paintDone/);
assert.match(listingSrc, /keepBrowsing/);
assert.match(listingSrc, /quoteSeq/);
assert.match(listingSrc, /guestPopover/);
assert.match(listingSrc, /adultMinus/);
assert.match(listingSrc, /childPlus/);
assert.doesNotMatch(listingSrc, /reviewDetails/);
assert.doesNotMatch(listingSrc, /changeDatesCard/);
assert.doesNotMatch(listingSrc, /changeDatesReview/);
assert.doesNotMatch(listingSrc, /portalGuestPopover/);
assert.doesNotMatch(listingSrc, /cardGuests/);
assert.match(listingSrc, /backFromBooking/);
assert.match(listingSrc, /backFromCalendar/);
assert.match(listingSrc, /openCalendar\(/);
...
assert.doesNotMatch(listingSrc, /Send booking request/);
assert.doesNotMatch(listingSrc, /Request to book/);
assert.doesNotMatch(listingSrc, /inquiry_hold/);

const guestHtml = fs.readFileSync(path.join(__dirname, '../booking-v2.html'), 'utf8');
const indexHtml = fs.readFileSync(path.join(__dirname, '../index.html'), 'utf8');
for (const html of [guestHtml, indexHtml]) {
  assert.match(html, />Check availability</);
  assert.match(html, />Reserve</);
  assert.match(html, /id="pets"/);
  assert.match(html, /id="event"/);
  assert.match(html, /id="calendarBack"/);
  assert.match(html, /id="bookingBack"/);
  assert.match(html, /id="guestPopover"/);
  assert.match(html, /id="adultMinus"/);
  assert.match(html, /id="childPlus"/);
  assert.match(html, /data-open-guests/);
  assert.match(html, /Why book direct/);
  assert.match(html, /checkout-progress/);
  assert.match(html, /id="priceStep"/);
  assert.match(html, /browse-flyout/);
  assert.match(html, /Keep browsing/);
  assert.match(html, /id="requestDoneStep"/);
  assert.match(html, /id="doneRef"/);
  assert.match(html, /won.t be charged yet/);
  assert.match(html, /What.s next/);
  assert.match(html, /Complete your booking/);
  assert.doesNotMatch(html, /id="changeDatesCard"/);
  assert.doesNotMatch(html, /id="changeDatesReview"/);
  assert.doesNotMatch(html, />Change dates</);
  assert.match(html, /id="guestDetailsStep"/);
  assert.match(html, /id="reviewStep"/);
  assert.match(html, /id="reviewStayTitle"/);
  assert.match(html, /id="reviewContactTitle"/);
  assert.match(html, /id="reviewTripTitle"/);
  assert.match(html, /id="reviewAckTitle"/);
  assert.match(html, /id="reviewName"/);
  assert.match(html, /id="reviewPets"/);
  assert.match(html, /id="reviewEvent"/);
  assert.match(html, /review-trust/);
  assert.doesNotMatch(html, /id="reviewDetails"/);
  assert.match(html, /id="guestName"/);
  assert.match(html, /id="guestEmail"/);
  assert.match(html, /id="guestPhone"/);
  assert.match(html, /id="formGuests"/);
  assert.doesNotMatch(html, /id="cardGuests"/);
  assert.doesNotMatch(html, /id="guestMinus"/);
  assert.doesNotMatch(html, /id="guestPlus"/);
  assert.doesNotMatch(html, /Book Now/);
  assert.doesNotMatch(html, />Check dates</);
  assert.doesNotMatch(html, /24-hour hold/);
  assert.doesNotMatch(html, /24-hour inquiry hold/);
  assert.doesNotMatch(html, /Request 24-hour hold/);
  assert.doesNotMatch(html, /Send hold request/);
  assert.doesNotMatch(html, /Send booking request/);
  assert.doesNotMatch(html, /Request to book/);
...
const listingCss = fs.readFileSync(path.join(__dirname, '../assets/css/booking-listing.css'), 'utf8');
const v2Css = fs.readFileSync(path.join(__dirname, '../assets/css/booking-v2.css'), 'utf8');
assert.match(listingCss, /\.booking-selectors\{[^}]*overflow:visible/);
assert.doesNotMatch(listingCss, /\.booking-selectors\{[^}]*overflow:hidden/);
assert.match(v2Css, /guest-popover/);
assert.match(v2Css, /checkout-progress/);
assert.match(v2Css, /why-direct/);
assert.match(v2Css, /browse-flyout/);
assert.match(v2Css, /review-stay-card/);
assert.match(v2Css, /review-trust/);
assert.match(v2Css, /request-review-open/);
assert.match(v2Css, /request-done-open/);
