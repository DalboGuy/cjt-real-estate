...
assert.match(listingSrc, /Request to book/);
assert.match(listingSrc, /Send booking request/);
...
assert.match(listingSrc, /cardGuests/);
...
assert.doesNotMatch(listingSrc, /guestMinus/);
assert.match(listingSrc, /backFromBooking/);
assert.match(listingSrc, /backFromCalendar/);
assert.match(listingSrc, /openCalendar\('card'\)/);
...
for (const html of [guestHtml, indexHtml]) {
  ...
  assert.match(html, /What to expect next/);
  ...
  assert.doesNotMatch(html, /id="guestPopover"/);
  assert.doesNotMatch(html, /data-open-guests/);
  assert.doesNotMatch(html, /class="guest-popover"/);
...
assert.match(v2Css, /guest-select/);
